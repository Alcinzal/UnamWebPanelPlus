...
foreach ($stats as $stat) {
    ...
    $statsDataExtra[$date] = array(
        ...
        'Total Active' => $stat['st_totalActive'],
        'Total Paused' => $stat['st_totalPaused'],
        'Total Active + Idle' => $stat['st_totalActive'] + $stat['st_totalIdle']
    );
    ...
    <div class="plus-box">
        ...
        <div class="statisticsOptions">
            ...
            <div class="tooltipPlus">?
                <span style="width: 250px;" class="tooltiptextPlus">Gets average values based on chosen interval. Might
                    result
    ...
    <div class="plus-box">
        ...
        <div class="statisticsOptions">
            ...
            <select id="chooseOnlineOffline">
                <option value="online">Active+Idle</option>
